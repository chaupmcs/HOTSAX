...
namespace SAX_update
{
    static class Heuristic
    {
        ...
        // Heuristic function
        public static List<double> Heuristic_Function(List<double> data, int N_LENGTH)
        {
            ...
            MakeTree_And_Table_Function(data, N_LENGTH, out tree, out count_table, out total_table);
                ...
                else
                {
                    ...
                    foreach (int q in inner_list)// inner loop
                    {
                        ...
                        else
                        {
                            ...
                            dist = MathFunctions.Distance(data.GetRange(p, N_LENGTH), data.GetRange(q, N_LENGTH));
